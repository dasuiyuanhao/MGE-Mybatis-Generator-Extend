...
public class DateUtil {
	 ...
	 * @return
	 */
	public static Date getDateOfDayBefore(Date date,int days) {
...
//		System.out.println((new SimpleDateFormat("yyyy-MM-dd")).format(cal.getTime()));
	...
	public static String getStrOfDateByFormatter(Date date,String sFormatter) {
		String result=null;
		try {
			SimpleDateFormat sdf = new SimpleDateFormat(sFormatter);
