...
public class PetCriteria {
    ...
    public PetCriteria(int pageSize, int pageIndex) {
        this();
        this.pageSize=pageSize;
        this.pageIndex=pageIndex;
    }
    ...
    protected abstract static class GeneratedCriteria {
        ...
        public Criteria andSpeciesLikeInsensitive(String value) {
            addCriterion("upper(species) like", value.toUpperCase(), "species");
            return (Criteria) this;
        }
